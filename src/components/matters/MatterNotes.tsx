...
const notes = [
  {
    id: 1,
    content: "Client expressed concern about the pace of discovery. Assured them that we are making progress and explained the typical timeline for these types of matters.",
    date: "2023-10-10",
    author: "John Doe"
  },
  {
...
export function MatterNotes({ matterId }: { matterId: string }) {
  // In a real app, you would filter notes by matterId
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>Important notes and observations about the matter</CardDescription>
          </div>
          <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Add Matter Note</DialogTitle>
                <DialogDescription>
                  Create a new note for this matter. Notes are visible to all team members.
                </DialogDescription>
              </DialogHeader>
              <Form {...form}>
