...
const timelineItems = [
  ...
  },
  {
    ...
    description: "Sent update email to client regarding case status",
    date: "2023-09-25",
    user: "John Doe",
    icon: Mail
  },
...
export function CaseTimeline({ caseId }: { caseId: string }) {
  // In a real app, you would filter timeline items by caseId
  
  return (
    <Card>
      <CardHeader>
        <CardTitle>Case Timeline</CardTitle>
        <CardDescription>A chronological history of case activities</CardDescription>
      </CardHeader>
      <CardContent>
